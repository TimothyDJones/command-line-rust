...
const MULTI: &str = "tests/inputs/multi-blank.txt";
...
#[test]
fn multi() -> TestResult {
    run(&[MULTI], "tests/expected/multi-blank.txt.out")
}

// --------------------------------------------------
#[test]
fn multi_n() -> TestResult {
    run(&["-n", MULTI], "tests/expected/multi-blank.txt.n.out")
}

// --------------------------------------------------
#[test]
fn multi_b() -> TestResult {
    run(&["-b", MULTI], "tests/expected/multi-blank.txt.b.out")
}

// --------------------------------------------------
#[test]
fn multi_s() -> TestResult {
    run(&["-s", MULTI], "tests/expected/multi-blank.txt.s.out")
}

// --------------------------------------------------
#[test]
fn multi_s_long() -> TestResult {
    run(&["--squeeze-blank", MULTI], "tests/expected/multi-blank.txt.s.out")
}

// --------------------------------------------------
#[test]
fn multi_ns() -> TestResult {
    run(&["-s", "-n", MULTI], "tests/expected/multi-blank.txt.ns.out")
}

// --------------------------------------------------
#[test]
fn multi_bs() -> TestResult {
    run(&["-s", "-b", MULTI], "tests/expected/multi-blank.txt.bs.out")
}
